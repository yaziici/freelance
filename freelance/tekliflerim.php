				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<div class="content">
							...
							<?php $teklifsor="SELECT * FROM teklif INNER JOIN uyeler ON teklif.teklif_verenid = uyeler.uye_id INNER JOIN ilanlar ON teklif.teklif_ilanid = ilanlar.ilan_id WHERE teklif_verenid=$uyecekk[uye_id]; ";
										...
										<div class="freelancer-overview-inner">
											...
											<div class="freelancer-name">
												...
												<div class="buttons-to-right always-visible margin-top-25 margin-bottom-0">
													...
													<a href="freeadmin/islem.php?teklif_id=<?php echo $teklifcek['teklif_id']; ?>&teklifiptal=ok" class="button gray ripple-effect ico" title="Teklifi İptal Et" data-tippy-placement="top"><i class="icon-feather-trash-2" onclick="return confirmDel();"></i></a>

...
<form name="avatardegis" action="freeadmin/islem.php" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-auto">
									<div class="avatar-wrapper" data-tippy-placement="bottom" title="Avatarı Değiştir">
										...
										<input class="file-upload" name="uyeavatar" type="file" accept="image/*"/>
									</div>
								</div>
...
<input class="btn btn-success" style="width: 100%" type="submit" name="avatardegis" value="Avatar Değiştir">
</form>
						</div>
					</div>
				</div>

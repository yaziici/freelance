...
<div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title">Yetkisiz Üye Listesi</h2>
                  ...
                  <div class="table-responsive ps ps--theme_default" data-ps-id="1c05b7b3-d04f-70fa-e18b-35ba99c5bdd4">
                    <table class="table center-aligned-table">
                      ...
                      <tbody>
                         ...
                         <?php if ($uyecek['uye_yetki']== 0 && $uyecek['uye_tip']== 0){ ?>
...
<a href="islem.php?uye_id=<?php echo $uyecek['uye_id']; ?>&uyesil=ok" onclick="return confirmDel();"><button style="width: 100%" class="btn btn-danger btn-sm">Kaldır</button></a>

<a href="islem.php?uye_id=<?php echo $uyecek['uye_id']; ?>&uyeyetkilendir=ok" onclick="return confirmDel(asd);"><button style="width: 100%; margin-top: 2%;" class="btn btn-success">Yetkilendir</button></a>
</form>

	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				<h3>Teklifleri Yönet</h3>

				<!-- Breadcrumbs -->
				<nav id="breadcrumbs" class="dark">
					<ul>
						<li><a href="#">Anasayfa</a></li>
						<li>Teklifleri Yönet</li>
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-material-outline-supervisor-account"></i> Teklif Verenlerin Listesi</h3>
							<div class="sort-by">
						...
						<div class="content">
							...
							<?php $teklifsor="SELECT * FROM teklif INNER JOIN uyeler ON teklif.teklif_verenid = uyeler.uye_id INNER JOIN ilanlar ON teklif.teklif_ilanid = ilanlar.ilan_id WHERE teklif_alanid=$uyecekk[uye_id]; ";
                              $sql=mysqli_query($con,$teklifsor);
                              while($teklifcek=mysqli_fetch_assoc($sql)){ ?>

                              	<?php if ($teklifcek['teklif_durum']=="0" && $teklifcek['teklif_tamam']=="0"){ ?>
								<li>
									<!-- Overview -->
										...
										<div class="freelancer-overview-inner">
											...
											<div class="freelancer-name">
												...
												<div class="buttons-to-right always-visible margin-top-25 margin-bottom-0">
													...
													<a href="freeadmin/islem.php?teklif_id=<?php echo $teklifcek['teklif_id']; ?>&teklifonayla=ok&teklif_sahipid=<?php echo $teklifcek['uye_id']; ?>" class="button gray ripple-effect ico" title="Teklifi Onayla" data-tippy-placement="top"><i class="icon-feather-check" onclick="return confirmDel();"></i></a>
													



													<a href="freeadmin/islem.php?teklif_id=<?php echo $teklifcek['teklif_id']; ?>&teklifsil=ok" class="button gray ripple-effect ico" title="Teklifi Kaldır" data-tippy-placement="top"><i class="icon-feather-trash-2" onclick="return confirmDel();"></i></a>
												</div>
											</div>
										</div>
									</div>
